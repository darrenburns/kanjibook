...
const EditorFooter: React.FC<EditorFooterProps> = ({ fontSize, setFontSize }) => {
  ...
  return (
    <div className="bg-gray-200 text-gray-600 border-t border-gray-300 flex items-center justify-end p-1 select-none">
      <button
      ...
      <span className="px-2 text-sm border-y bg-gray-200w-auto text-center border-gray-300">{fontSize}px</span>
      <button
